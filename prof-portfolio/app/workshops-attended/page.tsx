...
export default function WorkshopsAttendedPage() {
  return (
    <PageTransition>
      <main className="pt-20 min-h-screen">
        <section className="py-16 md:py-24 px-4 md:px-8 lg:px-16">
          <div className="max-w-4xl mx-auto">
            <PageHeader
              title="Workshops and Conferences Attended"
              subtitle={`Total: ${workshopsAttended.length} workshops and conferences`}
              breadcrumbItems={[{ label: "Workshops Attended" }]}
            />
